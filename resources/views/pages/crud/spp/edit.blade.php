                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-title mt-2">Detail data spp {{ $sppData->nama_spp }}</div>
                        </div>
                        <div class="card-body table-responsive">
                            ...
                            @endif --}}
                            <form action="{{ route('update-data-spp') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" class="form-control" name="id" value="{{ $sppData->id_spp }}">
                                    ...
                                    <div class="col-12 col-md-6 p-0">
                                        <div class="form-group px-0 py-1">
                                            <input type="number" class="form-control" name="tahun"
                                                value="{{ $sppData->tahun }}" placeholder="TAHUN">
                                            @error('tahun')
                                    ...
                                    <div class="col-12 col-md-6 p-0">
                                        <div class="form-group px-0 py-1">
                                            <input type="text" class="form-control" name="nominal"
                                                value="{{ $sppData->nominal }}" placeholder="Nominal">
                                            @error('nominal')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
